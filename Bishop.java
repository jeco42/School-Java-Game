public class Bishop extends Piece
{
	...
	public Bishop(String color, Node location)
	{
	...
	//helper method for canMoveTo.  Determines if a path exists from the current coords to the dest coords
	...
	//helper method for verifyPath.  Determines if a set of coords is empty
